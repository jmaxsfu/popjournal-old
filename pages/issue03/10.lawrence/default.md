...
I would argue that while useful in certain contexts, none of these terms can be used as general terms if we want to take a holistic approach to the research publishing system. Therefore, I have developed my own terminology, which also takes into account the other models of research publishing as they exist in relation to each other. I categorize research publishing into four types or models: commercial academic publishing (CAP), non-profit academic publishing (NAP), organization-based research publishing (ORP), and commercial market-research publishing (CMP). This typology is shown in Error: Reference source not found with examples of participants, sectors, and formats.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td valign="top" class="td1">
        ...
        <p class="p2">NFPs: Ithaka Harbors, JSTOR, Informit</p>
